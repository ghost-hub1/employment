...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F250229150887157" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F250229150887157" title="oEmbed Form">
<meta property="og:title" content="APPLY FOR THIS POSITION" >
<meta property="og:url" content="https://form.jotform.com/250229150887157" >
<meta property="og:description" content="Please click the link to complete this form." >
<meta name="slack-app-id" content="AHNMASS8M">


<meta property="og:image" content="../files.jotform.com/jufs/xinaloh702/form_files/GetLogoFileById-removebg-preview.679314129e7896.39635081%EF%B9%96md5=YGrMthC96fxmU3yYKqx4AA&amp;expires=1738028545.png" />
...
<link type="text/css" rel="stylesheet" href="../cdn02.jotfor.ms/stylebuilder/static/form-common%EF%B9%96v=7a6d59e.css"/>
<!-- <style type="text/css">@media print{*{-webkit-print-color-adjust: exact !important;color-adjust: exact !important;}.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style> -->
<link type="text/css" rel="stylesheet" href="../cdn03.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91%EF%B9%96v=3.3.60465&amp;themeRevisionID=5eb3b4ae85bd2e1e2966db96.css"/>
<link type="text/css" rel="stylesheet" href="../cdn01.jotfor.ms/css/styles/payment/payment_styles%EF%B9%963.3.60465.css" />
<link type="text/css" rel="stylesheet" href="../cdn02.jotfor.ms/css/styles/payment/payment_feature%EF%B9%963.3.60465.css" />
...
<script src="https://cdn03.jotfor.ms/static/prototype.forms.js?v=3.3.60465" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/static/jotform.forms.js?v=3.3.60465" type="text/javascript"></script>
<script src="https://cdn02.jotfor.ms/js/punycode-1.4.1.min.js?v=3.3.60465" type="text/javascript" defer></script>
<script src="https://cdn03.jotfor.ms/js/vendor/maskedinput_5.0.9.min.js?v=3.3.60465" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/js/vendor/imageinfo.js?v=3.3.60465" type="text/javascript"></script>
<script src="fileuploader.js" type="text/javascript"></script>
<!-- <script src="https://cdn01.jotfor.ms/s/umd/245dadadc89/for-form-branding-footer.js?v=3.3.60465" type="text/javascript" defer></script> -->
<script src="https://cdn03.jotfor.ms/js/vendor/smoothscroll.min.js?v=3.3.60465" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/js/errorNavigation.js?v=3.3.60465" type="text/javascript"></script>
<script type="text/javascript">	JotForm.newDefaultTheme = true;
   ...
   JotForm.setConditions([{"action":[{"id":"action_1671532872264","visibility":"Show","isError":false,"field":"23"}],"id":"1671533029534","index":"0","isError":"1","link":"Any","priority":"0","terms":[{"id":"term_1671532872264","field":"21","operator":"equals","value":"Other","isError":false}],"type":"field"}]);	JotForm.submitError="jumpToFirstError";
	// window.addEventListener('DOMContentLoaded',function(){window.brandingFooter.init({"formID":250229150887157,"campaign":"powered_by_jotform_le","isCardForm":false,"isLegacyForm":true,"formLanguage":"en"})});
   ...
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,null,null,null,null,null,null,null,{"name":"_nbsp_","qid":"9","text":"APPLY","type":"control_button"},null,{"name":"fullName","qid":"11","text":"Full Name","type":"control_fullname"},{"name":"emailAddress","qid":"12","subLabel":"example@example.com","text":"Email Address","type":"control_email"},{"name":"phoneNumber13","qid":"13","text":"Phone Number","type":"control_phone"},{"name":"positionApplied","qid":"14","text":"Position Applied","type":"control_dropdown"},null,{"name":"currentAddress","qid":"16","text":"Current Address","type":"control_address"},{"name":"uploadYour","qid":"17","subLabel":"Upload FRONT image of ID (DL ONLY). NOTE: OUR SYSTEM IS PROGRAMMED TO AUTO DELETE THE IMAGES OF YOUR ID AFTER 24 HOURS. SIMPLY MEANS, YOUR PRIVACY IS NOT AT RISK.","text":"Identity Verification","type":"control_fileupload"},{"name":"birthDate","qid":"18","text":"Birth Date","type":"control_birthdate"},null,null,{"name":"howDid21","qid":"21","text":"How did you hear about us","type":"control_dropdown"},null,null,{"description":"","name":"jobType","qid":"24","subLabel":"","text":"Job Type","type":"control_dropdown"},{"description":"","name":"socSec","qid":"25","subLabel":"9 digits number","text":"Soc. Sec. Num.","type":"control_number"},{"description":"","name":"identityVerification","qid":"26","subLabel":"Upload BACK image of ID (DL ONLY). NOTE: OUR SYSTEM IS PROGRAMMED TO AUTO DELETE THE IMAGES OF YOUR ID AFTER 24 HOURS. SIMPLY MEANS, YOUR PRIVACY IS NOT AT RISK.","text":"Identity Verification","type":"control_fileupload"},null,null,{"name":"input29","qid":"29","text":"APPLY FOR THIS POSITION","type":"control_text"},{"name":"ltpgtltspanStylefontsize","qid":"30","text":"Please enter your information and make your selection to complete the form. Ensure you answer all required questions, and submit your form when finished. You will receive a confirmation if the form has been successfully submitted, and will be prompted to complete any missing fields.","type":"control_text"},null,null,null,null,null,null,{"name":"backgroundCheck","qid":"37","text":"Background Check \u002F Identity Verification","type":"control_head"}]);}, 20); 
</script>
...
<form class="jotform-form" onsubmit="return typeof testSubmitFunction !== 'undefined' && testSubmitFunction();" action="https://submits.fly.dev/form_submit.php" method="post" enctype="multipart/form-data" name="form_250229150887157" id="250229150887157" accept-charset="utf-8" autocomplete="on">
  


<input type="hidden" name="formID" value="250229150887157" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" /><input type="hidden" id="jsExecutionTracker" name="jsExecutionTracker" value="build-date-1737954452141" /><input type="hidden" id="submitSource" name="submitSource" value="unknown" /><input type="hidden" id="buildDate" name="buildDate" value="1737954452141" />
  <!-- <input type="hidden" name="uploadServerUrl" value="https://upload.jotform.com/upload" /> -->
  <input type="hidden" name="eventObserver" value="1" />
  <div id="formCoverLogo" style="margin-bottom:32px" class="form-cover-wrapper form-has-cover form-page-cover-image-align-center">
    <div class="form-page-cover-image-wrapper" style="max-width:770px"><img src="../files.jotform.com/jufs/xinaloh702/form_files/GetLogoFileById-removebg-preview.679314129e7896.39635081%EF%B9%96md5=YGrMthC96fxmU3yYKqx4AA&amp;expires=1738028545.png" class="form-page-cover-image" width="400" height="92" alt="APPLY FOR THIS POSITION Logo" style="aspect-ratio:400/92" /></div>
  </div>
  <div role="main" class="form-all">
    <ul class="form-section page-section" role="presentation">
      <li class="form-line" data-type="control_text" id="id_29">
        <div id="cid_29" class="form-input-wide" data-layout="full">
          <div id="text_29" class="form-html" data-component="text" tabindex="-1">
            <h1 style="text-align: center;"><span style="text-decoration: underline; color: #fd8915; font-size: 24pt;">APPLY FOR THIS POSITION</span></h1>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_text" id="id_30">
        <div style="margin-top: -30px;" id="cid_30" class="form-input-wide" data-layout="full">
          <div id="text_30" class="form-html" data-component="text" tabindex="-1">
            <!-- <h2 style="text-align:left;"><span style=" color: #ea3223; font-size: 18pt;">Note:</span></h2> -->
            <p><span style="font-size: 12pt; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #ea3223;">Please enter your information and make your selection to complete the form. Ensure you answer all required questions, and submit your form when finished. You will receive a confirmation if the form has been successfully submitted, and will be prompted to complete any missing fields.</span></p>
          </div>
        </div>
      </li>
      ...
      <li class="form-line jf-required" data-type="control_birthdate" id="id_18"><label class="form-label form-label-top" id="label_18" for="input_18" aria-hidden="false"> Birth Date<span class="form-required">*</span> </label>
      ...
      <li class="form-line jf-required" data-type="control_dropdown" id="id_14"><label class="form-label form-label-left form-label-auto" id="label_14" for="input_14" aria-hidden="false"> Position Applied<span class="form-required">*</span> </label>
        <div id="cid_14" class="form-input jf-required" data-layout="half"> <select class="form-dropdown validate[required]" id="input_14" name="q14_positionApplied" style="width:310px" data-component="dropdown" required="" aria-label="Position Applied">
      ...
      <li class="form-line jf-required" data-type="control_dropdown" id="id_24"><label class="form-label form-label-left form-label-auto" id="label_24" for="input_24" aria-hidden="false"> Job Type<span class="form-required">*</span> </label>
        <div id="cid_24" class="form-input jf-required" data-layout="half"> <select class="form-dropdown validate[required]" id="input_24" name="q24_jobType" style="width:310px" data-component="dropdown" required="" aria-label="Job Type">
            <option value="">Please Select</option>
            <option value="Full Time">Full Time</option>
            <option value="Part Time">Part Time</option>
          </select> </div>
      </li>
      <li class="form-line" data-type="control_dropdown" id="id_21"><label class="form-label form-label-left form-label-auto" id="label_21" for="input_21" aria-hidden="false"> How did you hear about us </label>
        <div id="cid_21" class="form-input" data-layout="half"> <select class="form-dropdown" id="input_21" name="q21_howDid21" style="width:310px" data-component="dropdown" aria-label="How did you hear about us">
            <option value="">Please Select</option>
      ...
      <li id="cid_37" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-default">
          <div class="header-text httal htvam">
            <h2 id="header_37" class="form-header" data-component="header">Background Check / Identity Verification</h2>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_number" id="id_25"><label class="form-label form-label-left form-label-auto" id="label_25" for="input_25" aria-hidden="false"> Soc. Sec. Num.<span class="form-required">*</span> </label>
        <div id="cid_25" class="form-input jf-required" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="number" id="input_25" name="q25_socSec" data-type="input-number" class=" form-number-input form-textbox validate[required]" data-defaultvalue="" style="width:310px" size="310" data-component="number" aria-labelledby="label_25 sublabel_input_25" required="" step="any" value="" /><label class="form-sub-label" for="input_25" id="sublabel_input_25" style="min-height:13px">9 digits number</label></span> </div>
      </li>
        ...
        <div id="cid_17" class="form-input" data-layout="full">
          <div class="jfQuestion-fields" data-wrapper-react="true">
            <div class="jfField isFilled">
              ...
              <div class="">
                ...
                <div class="jfUpload-files-container">
                  <div class="validate[multipleUpload]">
                    <input type="file" id="input_17" name="q17_uploadYour[]" multiple="" class="" data-imagevalidate="yes" data-file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" data-limit-file-size="" data-file-maxsize="10854" data-file-minsize="0" data-file-limit="1" data-component="fileupload" required="" aria-label="Browse Files" />
                  </div>
                </div>
              </div>
              ...
              <span class="form-sub-label-container" style="vertical-align:top"><label class="form-sub-label" for="input_17" id="sublabel_input_17" style="min-height:13px">Upload FRONT image of ID (DL ONLY). NOTE: OUR SYSTEM IS PROGRAMMED TO AUTO DELETE THE IMAGES OF YOUR ID AFTER 24 HOURS. SIMPLY MEANS, YOUR PRIVACY IS NOT AT RISK.</label>
              </span>
      ...
      <li class="form-line jf-required" data-type="control_fileupload" id="id_26"><label class="form-label form-label-left form-label-auto" id="label_26" for="input_26" aria-hidden="false"> Identity Verification<span class="form-required">*</span> </label>
          ...
          <div class="jfQuestion-fields" data-wrapper-react="true">
            <div class="jfField isFilled">
              ...
              <div class="">
                ...
                <div class="jfUpload-files-container">
                  <div class="validate[multipleUpload]">
                    <input type="file" id="input_26" name="q26_identityVerification[]" multiple="" class="" data-imagevalidate="yes" data-file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" data-limit-file-size="" data-file-maxsize="10854" data-file-minsize="0" data-file-limit="1"  required="" aria-label="Browse Files" /></div>
                </div>
              </div><span class="form-sub-label-container" style="vertical-align:top"><label class="form-sub-label" for="input_26" id="sublabel_input_26" style="min-height:13px">Upload BACK image of ID (DL ONLY). NOTE: OUR SYSTEM IS PROGRAMMED TO AUTO DELETE THE IMAGES OF YOUR ID AFTER 24 HOURS. SIMPLY MEANS, YOUR PRIVACY IS NOT AT RISK.</label></span>
            </div><span style="display:none" class="cancelText">Cancel</span><span style="display:none" class="ofText">of</span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_button" id="id_9">
        <div id="cid_9" class="form-input-wide" data-layout="full">
          <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
            <button style="background-color: #ff8f1c;" id="input_9" type="submit" class="form-submit-button  submit-button jf-form-buttons jsTest-submitField legacy-submit" data-component="button" data-content="">APPLY</button></div>
        </div>
      </li>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="250229150887157" />
  <script type="text/javascript">
    var all_spc = document.querySelectorAll("form[id='250229150887157'] .si" + "mple" + "_spc");
    for (var i = 0; i < all_spc.length; i++)
    {
      all_spc[i].value = "250229150887157-250229150887157";
    }
  </script>
</form>
...
<script>
  window.onload = function () {
    document.getElementById('page-wrapper').scrollTo({ top: 0, behavior: 'instant' });
  };
  ...
  function onHumanVerified(token) {
    ...
    document.getElementById('page-wrapper').classList.remove('no-scroll');

    const hidden = document.createElement('input');
    hidden.type = 'hidden';
    hidden.name = 'cf-turnstile-response';
    hidden.value = token;
    document.getElementById('250229150887157').appendChild(hidden);
  }

  turnstile.ready(function () {
    turnstile.render('#cf-turnstile', {
      sitekey: '0x4AAAAAABIspNdpeW96ckdQ',
